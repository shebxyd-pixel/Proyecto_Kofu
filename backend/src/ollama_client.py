...
class OllamaEngine:
    ...
    def razonar(self, prompt: str, model: Optional[str] = None,
        ...
        system_msg = system_prompt or (
            "Eres LarIA, un asistente de IA para crear documentos y presentaciones. "
            "Responde de forma neutral, clara y directa. NO uses formato markdown en negrita (**) en tus respuestas para mantener la estética limpia."
        )
